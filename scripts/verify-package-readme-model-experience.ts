...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/web/browser': { kind: 'indirect', reason: 'The service seam delegates every model-visible schema and result to dsh-tool-browser.' },
  'packages/web/browser-playwright-local': { kind: 'indirect', reason: 'The provider backend delegates every model-visible schema and result to dsh-tool-browser.' },
