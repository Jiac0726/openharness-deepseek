...
Source: [`packages/web/browser/src/index.ts:24`](../packages/web/browser/src/index.ts)
...
Source: [`packages/web/browser-playwright-local/src/index.ts:21`](../packages/web/browser-playwright-local/src/index.ts)
...
- `@deepseek-ai/dsh-tool-browser` — requires `tools` · `browser` ([`packages/web/tool-browser/src/index.ts`](../packages/web/tool-browser/src/index.ts))
