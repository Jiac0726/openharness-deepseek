...
| [browser.md](browser.md) | interactive browser automation: branded tab ids, bounded DOM snapshots, provider selection, Playwright isolation, and network host policy |
