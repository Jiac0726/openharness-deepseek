...
import browserControlRemote from '@deepseek-ai/dsh-browser-playwright-local/remote'
...
export type {} from '@deepseek-ai/dsh-browser-playwright-local/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, browserControlRemote,
    ]) {
